...
import com.example.project1.network.repository.MemesRepositoryImpl
...
val networkModule = module {
    ...
    single { MemesApiProvider(retrofit = get()) }
}

val repositoryModule = module {
    single { MemesRepositoryProvider(memesApi = get()) }
}
...
fun MemesApiProvider(retrofit: Retrofit): MemesApi = retrofit.create(MemesApi::class.java)
...
fun MemesRepositoryProvider(memesApi: MemesApi): MemesRepository = MemesRepositoryImpl(memesApi)
